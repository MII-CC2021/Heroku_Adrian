...
//import edu.cc.examples.springdata.services.ICommentService;
...
public class UserController {
	...
	public String comment(Model model) {
		log.info("Ejecutando método index en controlador UserController");
	    //List<Comentarios> comentarios = commentService.listadoComentarios();
	...
	public String addComment(User u) {
		log.info("Ejecutando método addComment en controlador UserController");
		return "formComment";
	}
